...
class EditarRolFragment : Fragment(R.layout.fragment_editar_rol) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Vincular los botones usando los IDs específicos de la pantalla de edición
        ...
        btnConfirmar.setOnClickListener {
            // Aquí irá la lógica para actualizar el rol existente (Ej. UPDATE en SQL)
            regresarAListaRoles()
        }

        // Controlar el gesto de retroceso del sistema
